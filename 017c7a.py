...
def _precompute_primorial():
    """Precomputes the product of the first 100 prime numbers (up to 541)."""
    primes = []
    candidate = 2
...
SMALL_PRIMES_PRODUCT = _precompute_primorial()
