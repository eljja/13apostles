...
def search_primes():
    ...
    # Precomputed product of all odd primes up to 97
    SIEVE_PRODUCT = 16294579238195022365213197607593649983416201655
    ...
    while True:
        ...
        # Fast C-level GCD sieve pre-filter (eliminates ~68.5% of odd composites)
